    ...
    components: {
      schemas: {
        Employee: {
          type: "object",
          required: [
            "employeeId", "name", "email", "phone", "department", "position", "joiningDate"
          ],
          properties: {
            ...
            joiningDate: { type: "string", format: "date", example: "2023-01-10" },
            ...
            releaseDate: { type: "string", format: "date", example: "2025-12-31" }
          }
        },
        Leave: {
          type: "object",
          required: [
            "employeeId", "leaveType", "startDate", "endDate", "reason", "totalDays", "month", "year"
          ],
          properties: {
            employeeId: { type: "string", example: "60f6a4dbf8a4b445dc0f5471" },
            leaveType: { type: "string", enum: ["full_day", "half_day"], example: "full_day" },
            ...
            appliedDate: { type: "string", format: "date-time", example: "2024-05-30T12:00:00Z" },
            approvedBy: { type: "string", example: "HR Manager" },
            approvalDate: { type: "string", format: "date", example: "2024-06-01" },
